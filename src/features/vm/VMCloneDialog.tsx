...
export function VMCloneDialog(props: VMCloneDialogProps) {
  ...
  const hosts = useHosts(props.openCloneDialog);
  const folders = useFolders(props.openCloneDialog);
  ...
  return (
    <>
      <Dialog open={props.openCloneDialog} onClose={handleCloseCloneDialog}>
        ...
        <DialogActions>
          <Button onClick={handleCloseCloneDialog} variant="contained" color="secondary">
            Cancel
          </Button>
          <Button onClick={handleClone} color="primary" variant="contained" disabled={loading}>
