  ...
  return (
    <>
      <Box sx={containerStyle}>
        <VMActionButton onClick={goBack} label="Go back" icon={ArrowBackIcon} />
        <VMActionButton label="Edit" onClick={handleClickOpenEditDialog} icon={EditIcon} />
        <VMActionButton label="Playbooks" icon={BuildIcon} />
        <VMActionButton label="Clone" onClick={handleClickOpenCloneDialog} icon={FileCopyIcon} />
        <VMActionButton
          label="Console"
          color="primary"
      ...
      />
      <VMEditDialog setOpenEditDialog={setOpenEditDialog} openEditDialog={openEditDialog} />
      <VMCloneDialog
